...
Answer: The phase that precedes phase 4 is phase 3 - Model Planning. In this phase the team will explore the structure of datasets and what analytic techniques need to be used. Also, the determination of whether or not a single model will suffice 
for the project. 
