...
Answer: The phase that is most commonly underestimated and revisited is phase 5, communication of results. This is because the results can be communicated to multiple shareholders and needs to be honest with regards to success or failure of model or models. The team also has to indicate for possible paths forward that the team might not have followed in their own process for reasons. 
