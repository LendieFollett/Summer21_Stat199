...
One suggestion I can comit to implementing is the use of a metadata file in order to document where any data I got came from. Specifically, I plan to create a metadata file for the most recent data gathered from the CDC, and I plan to do so in the future with any data gathered. 
