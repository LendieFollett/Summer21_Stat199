...
Micropolitan Interpretation (Count Model): 

Non core / Possibly Rural Interpretation (Count Model): 
...
<font size = "3">
HHSIZE INTERPRETATION (Gamma Model): With all other variables held constant, for individuals who purchase food, the mean amount of food expenditure changes by a factor of exp(-.22794) = .7961747. This means that for every new person that lives within the house the amount of money used to  buy food for each individual decreases by about 20.4% per person compared to the mean.
...
MICROPOLITAN INTERPRETATION (Gamma Model): With all other variables held constant

NON-CORE / POSSIBLY RURAL INTERPRETATION (Gamma Model): With all other variables held constant
</font>
