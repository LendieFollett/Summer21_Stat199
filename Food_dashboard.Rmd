...
<font size = "3">
Disability Interpretation (Zero-Inflation Model): With all other variables held constant, the odds a house is food insecure increase by a factor of exp(-1.0453348) = 0.3515741. This means that if there is a disabled person living within the household, the odds of a house having a food insecurity level of 1 or greater increases by 64.84%.

Education Interpretation (Zero-Inflation Model): With all other variables held constant, the odds that a household is food insecure decrease by a factor of exp(0.7795625) = 2.1805181. This means that for every person within the house with an associates degree or higher, the odds of a house having a food insecurity level of 1 or greater decreases by 118%.

Elderly Interpretation (Zero-Inflation Model): With all other variables held constant, the odds that a house is food insecure decrease by a factor of exp(0.6967225) = 2.0071634. This means that for every elderly person within the house, the odds of a house having a food insecurity level of 1 or greater decreases by 100%.
...
EMPLOYED INTERPRETATION (Gamma Model): With all other variables held constant, for individuals who purchase food, the mean amount of food expenditure increases by a factor of exp(.06672) = 1.0690010. This means that for every new employed individual within the household, the amount of money in U.S. dollars used to buy food for each individual increase by about 6.9% per person compared to the mean.

EDUCATION INTERPRETATION (Gamma Model): With all other variables held constant, for individuals who purchase food, the mean amount of food expenditure increases by a factor of exp(0.12464) = 1.1327362. This means that for every new educated individual within the household, the amount of money in U.S. dollars used to buy food for each individual increases by about 13.27% per person compared to the mean. 

Explanatory Variables that Decrease Food Expenditure:

HSIZE INTERPRETATION (Gamma Model): With all other variables held constant, for individuals who purchase food, the mean amount of food expenditure changes by a factor of exp(-.22794) = .7961747. This means that for every new person that lives within the house the amount of money used to  buy food for each individual decreases by about 20.4% per person compared to the mean.
...
DUCATION INTERPRETATION (Bernoulli Model): With all other variables held constant, the odds of spending $0 changes by a factor of exp(-0.25484) = .7750404. This means that for every new educated person within the household, the odds of said household spending $0 on food per person decreases by about 22.50%.
